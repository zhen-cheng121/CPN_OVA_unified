...
class WideResNet_CPN(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0, thres_type='multi', logit_temperature=0.01, global_thres=150):
        super(WideResNet_CPN, self).__init__()
        ...
        self.centers = nn.Parameter(torch.rand(num_classes, self.nChannels))
        if thres_type == 'multi':
