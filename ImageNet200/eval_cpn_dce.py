...
def calc_aurc_eaurc(softmax, correct):
    ...
    print("shape of softmax_max: ", softmax_max.shape)
    print("shape of correctness: ", correctness.shape)
...
def parse_args_and_config():
    ...
    parser.add_argument('--score_OOD', type=str, default='prob', choices=['dist', 'prob'], help='score function for rejection')
...
if __name__ == '__main__':
    ...
    model = Custom_ResNet(args.arch, args.num_class).cuda()
